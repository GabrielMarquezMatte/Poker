...
class Deck:
    ...
    def remove_cards(self, cards: "Deck") -> None: ...
    def pop_card(self) -> Card: ...
    def pop_random_card(self, generator: pcg64) -> Card: ...
...
def compare_hands(player_cards: Deck, table_cards: Deck, opponents_cards: list[Deck]) -> GameResult: ...
