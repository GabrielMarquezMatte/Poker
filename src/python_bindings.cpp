...
PYBIND11_MODULE(poker, m)
{
    ...
    py::class_<Deck>(m, "Deck")
        ...
        .def_static("create_deck", py::overload_cast<const std::vector<Card> &>(&Deck::createDeck), py::arg("cards"))
        .def_static("create_deck", py::overload_cast<const std::vector<Deck> &>(&Deck::createDeck), py::arg("decks"))
